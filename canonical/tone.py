...
content. Four values are recognized in v1:
...
tuple, so adding a fifth tone byte someday is a single-file change here
...
def _selftest():
    ...
    assert VALID_TONES == frozenset({0x00, 0x01, 0x0d, 0xff})
    ...
    # validate_tone accepts all four
    ...
    for bad in (0x02, 0x42, 0xfe, 0xc3):
        try:
            ...
            # Error message must list all four canonical tones
            msg = str(e)
