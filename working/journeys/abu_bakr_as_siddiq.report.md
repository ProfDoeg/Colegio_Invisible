...
- **`abraham.journey.json`** and **`jesus.journey.json`**: share the two inherited pins with this journey, the Kaaba (found in at least nineteen other files) and the Temple Mount. A statement about ground, not about contact, and on the house-style pass of 2026-08 the two names were cut from both campas as coincidental (no documented contact, same coordinate at a different era). **[A as to the shared pins]**
