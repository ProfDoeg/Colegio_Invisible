...
```mermaid
graph LR
  NadiaBoulanger["Nadia Boulanger"]
  NadiaBoulanger --> AaronCopland["Aaron Copland"]
  NadiaBoulanger --> VirgilThomson["Virgil Thomson"]
  NadiaBoulanger --> ElliottCarter["Elliott Carter"]
  NadiaBoulanger --> RoyHarris["Roy Harris"]
  NadiaBoulanger --> WalterPiston["Walter Piston"]
  NadiaBoulanger --> LouiseTalma["Louise Talma"]
  NadiaBoulanger --> ElieSiegmeister["Elie Siegmeister"]
  NadiaBoulanger --> MarcBlitzstein["Marc Blitzstein"]
  NadiaBoulanger --> PhilipGlass["Philip Glass"]
  NadiaBoulanger --> QuincyJones["Quincy Jones"]
  NadiaBoulanger --> JeanFrancaix["Jean Françaix"]
  NadiaBoulanger --> IgorMarkevitch["Igor Markevitch"]
  NadiaBoulanger --> DinuLipatti["Dinu Lipatti"]
  NadiaBoulanger --> TheodoreChanler["Theodore Chanler"]
  NadiaBoulanger --> LeonardBernstein["Leonard Bernstein"]
```
