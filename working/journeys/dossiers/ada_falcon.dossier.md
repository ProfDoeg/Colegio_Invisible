...
gantt
    dateFormat  YYYY
    axisFormat  %Y
    title Ada Falc\u00f3n Life Timeline
    section Key Events
    Born :milestone, 1905, 1d
    Stage Debut :milestone, 1916, 1d
    Film Debut :milestone, 1919, 1d
    First Recordings :milestone, 1925, 1d
    Joins Canaro :milestone, 1929, 1d
    Film "Idolos..." :milestone, 1934, 1d
    Retires :milestone, 1942, 1d
    Death :milestone, 2002, 1d
```
