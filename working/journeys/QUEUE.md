...
| 0 | **Peró** | architect, with Torres Armengol just queued, of the Teatro Gran Splendid (1919, Av. Santa Fe, Buenos Aires) — later converted into the Ateneo Grand Splendid bookstore, repeatedly named one of the world's most beautiful bookshops; first name not yet identified; joins the corpus's Buenos Aires architecture cluster |
| 0 | **Torres Armengol** | architect, with Peró just queued, of the Teatro Gran Splendid (1919, Av. Santa Fe, Buenos Aires) — later converted into the Ateneo Grand Splendid bookstore, repeatedly named one of the world's most beautiful bookshops; first name not yet identified; joins the corpus's Buenos Aires architecture cluster |
