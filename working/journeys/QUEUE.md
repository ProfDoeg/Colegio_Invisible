...
| 0 | **Richard Dawkins** | English evolutionary biologist (b. 1941), author of The Selfish Gene (1976), which coined "meme" as a unit of cultural replication analogous to the gene; direct thread back to Burroughs's "language is a virus" and the whole self-replicating-information cluster the atlas keeps circling (Trithemius/al-Kindi cipher lineage, the cryptanalysts); gives the atlas its first real anchor in evolutionary biology |
