...
| 0 | **Lisoleth Charinga** | Artisan the author works with personally, one of his own associates - the same personal-associate category as arthur_ben and daniel_zachariah (both already researched from public sources). Charinga herself is NOT publicly documented, unlike arthur_ben was: the author will interview her directly, so this entry CANNOT run through the standard public-source research pipeline until that interview material exists. Hold until the author supplies it |
