...
| 0 | **Peró** | sculptor/monument-maker, name given without a first name; a real-search pass could NOT verify this surname against any Recoleta Cemetery or Argentina work (targeted search of recoletacemetery.com and general web found nothing) — recheck the original source/spelling before researching further, may be a misspelling or fragment |
| 0 | **Torres Armengol** | sculptor/monument-maker, name given without a first name; a real-search pass could NOT verify — the only match found (Francesc Torras Armengol, a 19th-century Spanish painter/sculptor) has no confirmed Argentina connection and may be an unrelated person — recheck the original source/spelling before researching further |
