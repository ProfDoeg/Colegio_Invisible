...
**[A `william_morris.journey.json`, stop "The stained glass, light through leaded saints"]** He draws the figures while Morris leads the colours; windows go into Jesus College and Christ Church, Oxford, and churches across England. **Flag (resolved 2026-08-11):** that stop's pin was **51.5225, -0.1235**, Queen Square in Bloomsbury — an anachronism, since the Firm took Queen Square only in 1865 and in 1862 worked at 8 Red Lion Square. The coordinated pin pass moved both files' stops to **51.5188, -0.1194**, the Red Lion Square workshop, which keeps this stop's "London drawing office" framing and drops the anachronism. The "Oxford / England (churches)" place string attributed to the Morris file here **does not exist** — the schema has no `place` key; it was a label inferred from that stop's campa during this pass. See `william_morris.report.md`, "Canonical-pin pass (2026-08-11)".
...
### 11.3 Flagged for a coordinated pass — since resolved (2026-08-11)

Four pins were wrong or imprecise but were marked in their own `date_confidence` as **inherited byte-identical from `william_morris.journey.json`**. Changing them here alone would have broken that cross-file convention *and* falsified each stop's own note, so they were left for a coordinated pass over both files.

**That pass happened on 2026-08-11. All four are resolved; nothing below is outstanding.** The corrections were made in `william_morris.journey.json` first and propagated to every inheriting file — this one, `jane_morris`, `elizabeth_bessie_burden`, `mary_may_morris`, and all `es/` counterparts, 39 stops in nine files. The full sourcing is in `william_morris.report.md`, "Canonical-pin pass (2026-08-11)". Summary of what changed here:

- **Exeter College, Oxford** (5 stops), 51.7548, -1.2554 → **51.7539, -1.256**, ~108 m. Was on the college's northern boundary; now 5 m from the Wikipedia geotag (51.753871, -1.256046) and beside the chapel in the front quad. **Resolved [A].**
- **17 Red Lion Square** (1 stop, "rooms with Morris"), 51.5183, -0.1178 → **51.5191, -0.1181**, ~91 m, the OSM address node for no. 17. **Resolved [A].**
- **8 Red Lion Square** (2 stops, "the prospectus of the Firm" and "the Firm dissolved"), 51.5183, -0.1178 → **51.5188, -0.1194**, ~124 m. No. 8 is absent from OSM; the point is extrapolated from the mapped 12→17 sequence along the south side. **Resolved [R]** — the three Red Lion Square stops no longer share one pin, because nos. 8 and 17 were different houses.
- **Merton Abbey Works**, 51.4158, -0.1772 → **51.4154, -0.1831**, ~412 m. **This section's proposed target was itself wrong**: 51.4131, -0.1834 is *Merton Abbey Mills*, the Liberty print-works south of the railway, not Morris's works. The Morris & Co. site ran south from Merton High Street to the Wandle on the north side of the line; its own Wikipedia article geotags it at 51.41539168, -0.183062017. **Resolved [A], with the audit's own suggestion corrected.**
- **"London, the cartoons for the leaded saints"**, 51.5225, -0.1235 → **51.5188, -0.1194**, ~500 m. Ruled a pin error, not a prose error: Queen Square was not the Firm's address in 1862. **Resolved [R].** The "place string" attributed to the Morris file was a phantom — see section 4.
