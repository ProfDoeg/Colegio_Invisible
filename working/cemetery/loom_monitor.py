...
QUIPU_KEYS = ["pinochet", "condor", "essay"]
...
# ---- HTML rendering --------------------------------------------------------
QUIPU_LABELS = {
    "pinochet": "Pinochet (320×400 3-bit, demonic)",
    "condor":   "Condor invitation (320×420 3-bit, demonic)",
    "essay":    "Cementerio de los Animales (essay)",
}
QUIPU_COLORS = {
    "pinochet": "#7a4a3a",  # dark terracotta
    "condor":   "#7a4a3a",  # dark terracotta (both demonic)
    "essay":    "#5d8aa8",  # blue (ordinary)
}
