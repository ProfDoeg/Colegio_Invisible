#!/usr/bin/env python3
"""Live loom for the consolidated Gana-forest broadcast, as textile weaving.
...
from forest_manifest import PIECES, NAMES

ARTIFACTS = Path(os.environ.get("LOOM_ARTIFACTS", THIS_DIR / "artifacts"))
OUT       = THIS_DIR / "loom.html"
PORT      = int(os.environ.get("PORT", "8765"))
POLL_INTERVAL = int(os.environ.get("POLL", "20"))
QUIPU_KEYS = [pid for pid, *_ in PIECES]

TONE_COLOR = {"reverence": "#b8860b", "play": "#6a9a4a", "seeking": "#5d8aa8",
